...
$video = get_field('vsoe_forum_video_embed_code');
$runtime = get_field('vsoe_forum_video_run_time');
  ...
  <?php if ( x_get_option( 'x_breadcrumb_display' ) )  :  x_breadcrumbs(); endif; ?>
    ...
    <div class="<?php x_main_content_class(); ?>" id="main" role="main">
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('forum'); ?>>

            <header class="entry-header">

                <h1 class="entry-title" ><span><h6 style="margin-bottom: 0; color: #555">VSOE Web Team Open Forum</h6></span> <?php esc_html( the_title() ); ?><span class="runtime"><?php echo $runtime; ?></span></h1>
