<?php
/*
* Template Name: Conditional Search Page Template
*/
get_header(); 
        ...
        <div class="search-header">
            ...
            <div class="searchFilter">
                ...
                <form name="SiteSelectSearch" method="get" action=""> <!-- Depending on radio button selection, sets value of siteSearch to ID of site, Viterbi, or USC CSE for script -->
                    ...
                    <input onchange="submit()" name="siteSearch" type="radio" value="<?php echo $vsoe_site_search; ?>" <?php if($_GET['siteSearch']==$vsoe_site_search) echo "checked=checked"; ?> > <span><?php echo $dept_name; ?></span>

                    <input onchange="submit()" name="siteSearch" type="radio" value="<?php echo $vsoe_viterbi_search; ?>" <?php if($_GET['siteSearch']==$vsoe_viterbi_search) echo "checked=checked"; ?> > <span>Viterbi School Sites</span>

                    <input onchange="submit()" name="siteSearch" type="radio" value="<?php echo $vsoe_usc_search; ?>" <?php if($_GET['siteSearch']==$vsoe_usc_search) echo "checked=checked"; ?> > <span>All USC Sites</span>
