<?php
/**
 * Template Name: All Contributors Archives
...
<div class="x-container max width offset">
    ...
    <div class="x-main full" id="main" role="main">
        ...
        <div class="x-container author-landing">
            ...
            //$user_query = new WP_User_Query( array( 'role' => 'author', 'hide_empty' => true, 'fields' => 'all', 'paged' => $paged, 'posts_per_page' => -1 ) );


			$args = array( 'role' => 'contributor', 'hide_empty' => true, 'fields' => 'all', 'paged' => $paged, 'posts_per_page' => 12 );
			// Query for the users
