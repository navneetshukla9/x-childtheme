        ...
        <div class="x-section archive" style="padding: 30px 0 0;">
            <div class="x-container max">
                <div class="x-column x-sm x-1-1">
                    <h1 class="archive-page-title" ><span><h6 style="margin-bottom: 0; color: #555">VSOE Web Team</h6></span> Tutorials</h1>
                </div>
            </div>
        </div>
        <div class="x-section loop-archive" style="padding: 0">
            <div class="x-container max">
                ...
                $args = array(
                    ...
                    'posts_per_page' => 24,
                    'paged' => $paged,
                    //'meta_key' => 'vsoe_tutorial_video_display_order',
                        ...
                        <div class="x-column x-sm x-1-4">
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                ...
                                <div class="entry-content eh">
                                    <a href="<?php the_permalink(); ?>" title="View story">
                                    <h5><?php esc_html( the_title() ); ?></a> <span class="runtime">(<?php echo get_field('vsoe_tutorial_video_run_time'); ?>)</span></h5>
                                   <?php the_excerpt(); ?>
                                </div><!-- .entry-content -->
                            </article><!-- #post-## -->
                        </div>
